...
# from human_gender.Face_info import det_gend['GTK3Agg', 'GTK3Cairo', 'GTK4Agg', 'GTK4Cairo', 'MacOSX', 'nbAgg', 'QtAgg', 'QtCairo', 'Qt5Agg', 'Qt5Cairo', 'TkAgg', 'TkCairo', 'WebAgg', 'WX', 'WXAgg', 'WXCairo', 'agg', 'cairo', 'pdf', 'pgf', 'ps', 'svg', 'template']
# import matplotlib
# matplotlib.use('template')  # or 'Agg' or 'Qt5Agg' depending on your system PyQt6, PySide6, PyQt5, PySide2
import sys
import numpy as np
import shutil
import datetime
...
def detect_face():
    ...
    while True:
        ...
        if True:
            ...
            # pil_image = Image.fromarray(Falsh_frame)
            # plt.imshow(pil_image)
            # plt.axis('off')  # Turn off axesqqqqqqqqq
            # plt.show()
